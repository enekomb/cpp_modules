...
/*   Updated: 2025/09/02 13:23:49 by emunoz           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	Bureaucrat::signForm(Form &param)
{
	if (param.getSigStatus())
	{
		std::cout << "Bureaucrat " << this->_name;
		std::cout << " couldnt sign form " << param.getName(); 
		std::cout << " because it's already signed." << std::endl;
		return (false);
	}
	else if (this->_grade > param.getSignGrade())
	{
		std::cout << "bureaucrat " << this->_name;
		std::cout << " couldnt sign form " << param.getName(); 
